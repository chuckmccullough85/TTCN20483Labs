...
public class CompanyTest
{
    ...
    void TestContractorHire()
    {
        var comp = new Company("Acme", "12-1234567");
        var contractor = new Contractor("John Doe", 50);
        comp.Hire(contractor);
        var net = comp.Pay();
        if (!net.Is(2500))
            throw new Exception("Company Pay is not correct for contractor");
    }

    void TestInternHire()
    {
        var comp = new Company("Acme", "12-1234567");
        var intern = new Intern("John Doe");
        comp.Hire(intern);
        var net = comp.Pay();
        if (!net.Is(50))
            throw new Exception("Company Pay is not correct for intern");
    }
    ...
    void TestPayable()
    {
        var c = new Company("Acme", "12-1234567");
        var robot = new Robot();
        c.Hire(robot);
        var net = c.Pay();
    }
...
class Robot : Payable
{
    public double Pay() { Console.Beep(); return 0; }
}

public class ContractorTest
{
    private Contractor contractor = new Contractor("John Doe", 50);
    ...
    public void PayTest()
    {
        var net = contractor.Pay();
        if (net != 2500 || !contractor.YtdEarnings.Is(2500))
            throw new Exception("Contractor Pay is not correct");
    }
}
public class InternTest
{
    private Intern intern = new Intern("John Doe");
    public InternTest()
    {
        PayTest();
    }
    ...
    {
        var net = intern.Pay();
        if (net != 50 || !intern.YtdEarnings.Is(50))
            throw new Exception("Intern Pay is not correct");
    }
}
